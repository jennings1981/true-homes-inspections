  ...
  return (
    <LocationPage
      ...
      paragraphs={[
        ...
        "Every Sandpoint home inspection follows ASHI standards and covers all accessible systems and components. You'll receive a detailed digital report with photos within 24 hours, and we're available to answer questions throughout the process.",
      ]}
      localFacts={[
